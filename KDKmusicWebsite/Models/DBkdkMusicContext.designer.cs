...
namespace KDKmusicWebsite.Models
{
	...
	public partial class DBkdkMusicContextDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteUser(User instance);
		...
		public DBkdkMusicContextDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DBkdkMusicContextDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DBkdkMusicContextDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DBkdkMusicContextDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
        public DBkdkMusicContextDataContext() : base(global::System.Configuration.ConfigurationManager.ConnectionStrings["KDKMusicConnectionString"].ConnectionString, mappingSource)
        {
            OnCreated();
        }
    ...
    partial void OnSong_IdChanged();
    partial void OnPlaylistSong_IdChanging(long value);
    partial void OnPlaylistSong_IdChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PlaylistSong_Id", AutoSync=AutoSync.Always, DbType="BigInt NOT NULL IDENTITY", IsDbGenerated=true)]
		public long PlaylistSong_Id
		{
			get
			{
				return this._PlaylistSong_Id;
			}
			set
			{
				if ((this._PlaylistSong_Id != value))
				{
					this.OnPlaylistSong_IdChanging(value);
					this.SendPropertyChanging();
					this._PlaylistSong_Id = value;
					this.SendPropertyChanged("PlaylistSong_Id");
					this.OnPlaylistSong_IdChanged();
				}
			}
		}
